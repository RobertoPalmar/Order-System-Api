...
router.put("/:membershipID", validateBusinessAuth, requireRole(UserRole.ADMIN), validateBody(PartialMembershipDTOIn), MembershipController.updateMemberRole);
router.delete("/:membershipID", validateBusinessAuth, requireRole(UserRole.ADMIN), MembershipController.removeMember);
