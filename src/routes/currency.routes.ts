...
router.put('/updateCurrency/:currencyID', validateBusinessAuth, requireRole(UserRole.ADMIN), validateBody(PartialCurrencyDTOIn), CurrencyController.updateCurrency);
router.delete('/deleteCurrency/:currencyID', validateBusinessAuth, requireRole(UserRole.ADMIN), CurrencyController.deleteCurrency);
